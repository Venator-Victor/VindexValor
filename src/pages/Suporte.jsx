      ...
      >
          ...
          {faqs.map((faq, index) => (
            <div
              ...
              className={`bg-gray-50 dark:bg-vindex-bg rounded-lg overflow-hidden border transition-colors ${
                openFaq === index
                  ? 'border-l-2 border-vindex-success border-t border-r border-b border-gray-200 dark:border-vindex-border/50'
              ...
              >
                ...
                <ChevronDown
                  ...
                  className={`text-gray-500 dark:text-vindex-text/60 transition-transform duration-200 flex-shrink-0 ${
                    openFaq === index ? 'rotate-180 text-vindex-success' : ''
                  }`}
                />
              </button>
              {openFaq === index && (
        ...
        <div className="mt-5 pt-5 border-t border-gray-100 dark:border-vindex-border/30 flex items-center justify-between">
          ...
          <a
            ...
            className="text-sm font-medium text-vindex-success hover:underline"
          >
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="bg-white dark:bg-vindex-card rounded-xl p-6 border border-gray-200 dark:border-vindex-border flex items-center gap-4 shadow-sm hover:shadow-md hover:border-vindex-success/50 transition-all group"
          >
            <div className="w-12 h-12 rounded-lg bg-gray-50 dark:bg-vindex-bg flex items-center justify-center flex-shrink-0">
              <svg className="w-6 h-6 text-gray-700 dark:text-vindex-text group-hover:text-vindex-success transition-colors" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              <p className="text-gray-900 dark:text-vindex-text font-medium group-hover:text-vindex-success transition-colors">GitHub</p>
          ...
          >
            <div className="w-12 h-12 rounded-lg bg-gray-50 dark:bg-vindex-bg flex items-center justify-center flex-shrink-0">
              <svg className="w-6 h-6 text-gray-700 dark:text-vindex-text group-hover:text-vindex-success transition-colors" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
              </svg>
            </div>
            <div>
              <p className="text-gray-900 dark:text-vindex-text font-medium group-hover:text-vindex-success transition-colors">E-mail</p>
          ...
          >
            ...
            <div>
              <p className="text-gray-900 dark:text-vindex-text font-medium group-hover:text-vindex-success transition-colors">LinkedIn</p>
