...
export const defaultFinanceValue = {
  ...
  fetchAllData: vi.fn(),
  fetchFaturas: vi.fn(),
  createFatura: vi.fn().mockResolvedValue({ id: 'fatura-1' }),
  fetchComprasFatura: vi.fn().mockResolvedValue([]),
  createCompraFatura: vi.fn().mockResolvedValue({}),
  updateCompraFatura: vi.fn().mockResolvedValue({}),
  deleteCompraFatura: vi.fn().mockResolvedValue(true),
